const ANTIPATTERNS = [
  ...
  // 명명 규칙 위반
  { pattern: /(\w+)Dao\s+\1Dao\s*=/, ruleId: 'naming-dao', severity: 'error',
    message: "DAO 변수명에 'Dao' 접미사를 붙이지 마세요.",
    suggestion: 'UserDao user = new UserDao(); 형태로 사용하세요.' },
  { pattern: /DataSet\s+ds\s*=/, ruleId: 'naming-dataset-single', severity: 'error',
